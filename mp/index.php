...
<body>
    <nav >
        ...
        <label class="logo">
        <i class="fa-solid fa-v fa-2xl" style="color: #1cf2ee;"></i><i class="fa-solid fa-info fa-2xl" style="color: #2a416a;"></i><i class="fa-solid fa-bullhorn " style="color: #fffb06;"></i></label>
    <ul>
        <li><a href="home"><i class="fa-solid fa-house-chimney-user" style="color: hsl(255, 89%, 49%);"> Home</i></a></li>
        <li><a href="login.php"><i class="fa-solid fa-envelope fa-" style="color: #3e04ec;"> contact us </i></a></li>
        <li><a href="login.php"><i class="fa-sharp fa-solid fa-calendar-days fa-" style="color:  hsl(255, 94%, 52%);"> vaccination </i></a></li>
        <li><a href="login.php"><i class="fa-solid fa-user" style="color: hwb(216 3% 7%);"> Login</i></a></li>
     </ul>
        </nav>
        <section>
            ...
            <section>
                <div class="f">
                    <h1>The purpose of vaccination is to stimulate the immune system to produce an immune response without causing the disease itself.</h1>
                    <Br><BR><BR>Vaccination is a process by which a person is administered a vaccine, which contains a weakened or killed form of a microorganism (such as a virus or bacterium) or parts of it. This immune response prepares the body to fight off the real infection if the person is exposed to it in the future, thus providing immunity and preventing or reducing the severity of the disease.
...
<br><br>
<img src="WhatsApp Image 2024-02-04 at 07.14.20.jpeg" width="80%">
<br>
<img src="WhatsApp Image 2024-02-04 at 07.14.19 (1).jpeg" width="80%">
<br>
<img src="WhatsApp Image 2024-02-04 at 07.14.19.jpeg" width="80%">
...
<script src="https://web3forms.com/client/script.js" async defer></script>
        ...
        <i class="fa-regular fa-copyright fa-2xl" style="color: #eff2ee;"></i>   copyright   Global Vaccination
        All Rights Reserved.

        <div class="logo"><i class="fa-solid fa-v" style="color: #1cf2ee;"></i><i class="fa-solid fa-info" style="color: #2a416a;"></i><i class="fa-solid fa-bullhorn " style="color: #eff309;"></i></div>
        </div>
