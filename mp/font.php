...
<nav class="header-nav-wrap">
            ...
            <li class="<?php echo (basename($_SERVER['PHP_SELF']) == 'font.php') ? 'current' : ''; ?>"><a class="smoothscroll" href="font.php"><i class="fa-solid fa-house-chimney-user" style="color: hsl(255, 89%, 49%);"> Home</i></a></li>
                <li><a class="smoothscroll"href="message.php"><i class="fa-solid fa-envelope fa-"> Contact Us </i></a></li>
                <li><a class="smoothscroll" href="vs.php"><i class="fa-sharp fa-solid fa-calendar-days fa-"> Vaccination </i></a></li>
                <li><img src="" alt="" width="12px"></li>
                <li><a class="smoothscrolli" href="login.php">Login</a></li>
                <li><a class="smoothscroll" href=""><i class="fa-solid fa-list fa-2xl"></i> </a></li>
    ...
    <a class="header-menu-toggle" href="#0"><span></span></a>
        ...
        <section>
            ...
            <section>
              <img src="https://media.istockphoto.com/id/1388268549/photo/baby-receiving-an-immunization.jpg?s=1024x1024&w=is&k=20&c=sth6Hyy3OCuotGnX4OiHJ-srhtTHbZDVfH12NY_zQ38=" alt="">
                <div class="f">
...
<h1>
  ...
  <br>
        ...
        <br>
  <input class="i" type="text" name=" user name" placeholder="user name"  id="username" required>
  <br>
  <br>
  <label>To</label>
  <br>
